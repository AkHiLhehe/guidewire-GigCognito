      ...
      <div style={{ padding: "28px 20px 0", maxWidth: 420, margin: "0 auto" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 24 }}>
          <div>
            ...
            <p style={{ margin: "4px 0 0", fontSize: 14, color: "rgba(255,255,255,0.45)" }}>Hi, {MOCK_WORKER.name.split(" ")[0]} 👋</p>
          </div>
        ...
        <div className="fade-in" style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.08)", borderRadius: 16, padding: "18px", marginBottom: 16 }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 14 }}>
            <div>
              ...
              <p style={{ margin: "4px 0 0", fontSize: 20, fontWeight: 600, color: "#fff" }}>{MOCK_WORKER.zone}</p>
            </div>
        ...
        <div className="fade-in" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10, marginBottom: 16 }}>
          {[
            { label: "Earned back this week", value: `₹${MOCK_WORKER.earningsProtected}`, color: "#1D9E75", mono: true },
            { label: "Claims this week",      value: `${MOCK_WORKER.claimsThisWeek} auto-paid`, color: "#378ADD", mono: false },
          ].map(s => (
